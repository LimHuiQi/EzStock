...
// Prepare a SQL query to count customer data where cust_id starts with 'CustDraft-' and matches the user_id
$sql = "SELECT COUNT(*) AS total FROM tbl_customer WHERE cust_id LIKE 'CustDraft-%' AND user_id = ?";
