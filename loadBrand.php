...
// Prepare a SQL query to fetch brands based on the user ID
$sql = "SELECT * FROM tbl_brands WHERE user_id = ?";
...
if ($result->num_rows > 0) {
    // Fetch all brands as an associative array
    $brands = $result->fetch_all(MYSQLI_ASSOC);
    echo json_encode($brands);
} else {
    // No brands found for this user
