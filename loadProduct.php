...
// Prepare a SQL query to fetch product data based on the user ID and prod_id starting with 'Prod-'
$sql = "SELECT * FROM tbl_products WHERE user_id = ? AND prod_id LIKE 'Prod-%'";
